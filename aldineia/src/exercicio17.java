...
/*
João recebeu seu salário e precisa pagar duas contas atrasadas. Em razão do seu atraso, 
ele deverá pagar multa de 2% sobre cada conta. 
...
public class exercicio17 {
    public static void main(String[] args) {
        ...
        System.out.println("O salario restante é: " + valsalario);
